This is a boilerplate to build a full stack web application using Typescript, React, Node.js, Express and Webpack. It is also configured with webpack-dev-server, eslint, prettier and babel.
...
src/server/index.ts is the entry point to the server application. Below is the src/server/index.ts file
